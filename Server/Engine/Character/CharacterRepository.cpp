...
std::vector<std::unique_ptr<CharacterModel>> CharacterRepository::findAllByIdUser( const int idUser ) {
    const std::string sql = R"SQL(
        SELECT
            id_character,
            id_user,
...
std::unique_ptr<CharacterModel> CharacterRepository::findByIdUserAndIdCharacter( const int idUser, const int idCharacter ) {
    const std::string sql = R"SQL(
        SELECT
            id_character,
            id_user,
