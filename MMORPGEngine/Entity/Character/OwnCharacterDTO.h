#ifndef OWNCHARACTERDTO_H
#define OWNCHARACTERDTO_H
...
class OwnCharacterDTO {
public:
    OwnCharacterDTO();
    ~OwnCharacterDTO();

    static OwnCharacterDTO fromModel( const CharacterModel* character );
    static OwnCharacterDTO fromJson( const Json::Value& json );
